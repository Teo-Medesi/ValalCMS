...
const Anchor = () => {
    ...
    if (element == null || element === 0)
    {
        ...
        return (
            <div ref={elementDropRef} onAuxClick={handleAuxClick} onMouseMove={handleMouseMovement} onContextMenu={(event) => event.preventDefault()} onClick={handleClick} className='relative cursor-pointer'>
