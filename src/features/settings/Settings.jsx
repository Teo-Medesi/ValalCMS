...
import SettingsIcon from "../../assets/svgs/gearIcon.svg"
import SectionsIcon from "../../assets/svgs/sectionsIcon.svg"
import MediaIcon from "../../assets/svgs/mediaIcon.svg"
import AddIcon from "../../assets/svgs/addIcon.svg"
import PagesIcon from "../../assets/svgs/pagesIcon.svg"
import DesignIcon from "../../assets/svgs/designIcon.svg"
import LayersIcon from "../../assets/svgs/layersIcon.svg"
    ...
    return (
        <SettingsContext.Provider value={[[isToggled, setIsToggled], [isToggledRelative, setIsToggledRelative]]}>
            <div className={isToggled ? 'w-2/5 flex flex-row h-screen bg-black-100 z-40 absolute' : isToggledRelative ? 'w-2/5 basis-2/5 flex flex-row h-screen bg-black-100 z-[1]' : 'basis-[5%] max-w-[5vw]'}>
                ...
                <div className={(isToggled || isToggledRelative) ? 'border-t-[12px] border-t-primary w-full z-50 overflox-x-hidden overflox-y-scroll  h-screen' : "hidden"}>
