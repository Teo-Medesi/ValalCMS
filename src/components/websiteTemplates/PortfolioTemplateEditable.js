...
const PortfolioTemplateEditable = () => {
  ...
  return (
    <>
      ...
      <TextSettings setIsActive={setIsTextSettingsActive} className={isTextSettingsActive ? "absolute z-[2] top-80 left-64" : "hidden"}/>
